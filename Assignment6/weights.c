...
typedef enum unit_e { G, KG, T, LB } Unit;
...
void to_unit_test(void) {
  test_within_weight(__LINE__, to_unit(make_weight(1000, G), KG),
                     make_weight(1, KG), 1e-6);
  test_within_weight(__LINE__, to_unit(make_weight(2, KG), G),
                     make_weight(2000, G), 1e-6);
  test_within_weight(__LINE__, to_unit(make_weight(1, T), KG),
                     make_weight(1000, KG), 1e-6);
  test_within_weight(__LINE__, to_unit(make_weight(1, LB), KG),
                     make_weight(0.45359237, KG), 1e-6);
  test_within_weight(__LINE__, to_unit(make_weight(1, KG), LB),
                     make_weight(2.20462, LB), 1e-3);
  test_within_weight(__LINE__, to_unit(make_weight(1000000, G), T),
                     make_weight(1, T), 1e-6);
}
